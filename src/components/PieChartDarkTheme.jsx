...
const PieChartDarkTheme = () => {
  return (
    <div className=" text-white p-6 rounded-2xl shadow-md w-full max-w-xl mx-auto bg-zinc-900 border-zinc-800">
      <div className="mb-5">
